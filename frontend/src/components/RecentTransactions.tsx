  ...
  return (
    <div className="card">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link to="/transactions" className="text-sm text-blue-400 hover:text-blue-300 font-medium">
          View All →
        </Link>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {transactions.map((tx: any) => (
            <div key={tx.id} className="flex items-center justify-between p-4 rounded-lg border border-slate-800/50 hover:bg-slate-800/30 hover:border-slate-700/50 transition-all">
